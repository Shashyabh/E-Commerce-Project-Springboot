...
import com.store.dtos.JwtRequest;
import com.store.dtos.JwtResponse;
import com.store.dtos.UserDto;
import com.store.entities.User;
import com.store.exceptions.BadApiRequest;
import com.store.securities.JwtHelper;
...
public class AuthController {
    ...
    public ResponseEntity<JwtResponse> loginWithGoogle(@RequestBody Map<String,Object> data) throws IOException {
        ...
        //To get the id Token from the request
        ...
        User user=null;
        user= userServices.findUserByEmailOptional(email).orElse(null);
